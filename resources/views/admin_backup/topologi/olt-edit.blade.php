                ...
                <form action="/admin/topologi/olt/{{ $olt->id }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="api_endpoint" class="form-control" id="api-endpoint" value="{{ $olt->api_endpoint ?? '/onuAllPonOnuList.asp' }}">
                        </div>
                        <div class="col-md-4">
...
document.addEventListener('DOMContentLoaded', function() {
    const sel = document.getElementById('olt-model');
    if (sel && sel.value) onModelChange(sel.value);
});
</script>
@endpush