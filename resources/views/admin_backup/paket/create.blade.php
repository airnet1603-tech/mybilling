                ...
                <div class="card-body py-3">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-sm"><input type="number" name="masa_aktif" id="masa_aktif" class="form-control form-control-sm @error('masa_aktif') is-invalid @enderror" value="{{ old('masa_aktif', 30) }}" required min="1"><select class="form-select form-select-sm" style="max-width:120px;" onchange="document.getElementById('masa_aktif').value=this.value;"><option value="">Pilih</option><option value="7">7 hari</option><option value="14">14 hari</option><option value="30">30 hari</option><option value="60">60 hari</option><option value="90">90 hari</option><option value="180">180 hari</option><option value="365">365 hari</option></select></div>
