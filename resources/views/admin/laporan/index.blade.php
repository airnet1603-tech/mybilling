...
<div class="mobile-topbar">
    ...
    <span style="color:#fff;font-weight:700;font-size:0.95rem;">ISP Billing</span>
</div>
...
<div class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="nav flex-column mb-0">
            ...
            <li><a href="/admin/laporan" class="nav-link active"><i class="fas fa-chart-bar"></i> Laporan</a></li>
