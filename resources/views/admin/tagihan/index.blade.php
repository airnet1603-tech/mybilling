...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .sidebar-brand .brand-icon { width: 34px; height: 34px; background: rgba(233,69,96,0.25); border-radius: 8px; display: flex; align-items: center; justify-content: center; color: var(--accent); font-size: 1rem; flex-shrink: 0; }
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    ...
                                    @if($t->status !== 'paid')
                                    <button class="btn btn-sm btn-success py-0 px-2" onclick="konfirmasi({{ $t->id }})" title="Konfirmasi Bayar">
