...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .interface-row { font-size: 0.82rem; }
...
<div class="main-content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <small class="text-muted">Status realtime router Mikrotik</small>
        </div>
        ...
        .then(data => {
            ...
            tbody.innerHTML = data.sessions.map(s => `
                <tr>
                    ...
                    <td>
                        <small class="text-primary fw-semibold">${formatBytes(s.bytes_in ?? 0)}</small>
                    </td>
                    <td>
                        <small class="text-success fw-semibold">${formatBytes(s.bytes_out ?? 0)}</small>
                    </td>
